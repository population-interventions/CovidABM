...
def MakeCostsMidFunction(contents, singleList, variables):
...
def EditCostsOutput(modelDir, singleList, variables):
	...
	while True:
		...
		if line.find('to CalculateMidCosts') > -1:
			...
			MakeCostsMidFunction(contents, singleList, variables)
			contents.append('end\n')
			break
		contents.append(line + '\n')
